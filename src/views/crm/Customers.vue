<template>
  <div>
            ...
            <CTable align="middle" class="mb-0 border" hover responsive>
              ...
              <CTableBody>
                <CTableRow v-for="item in tableExample" :key="item.name">
                  ...
                  <CTableDataCell>
                    <div>
                      <router-link :to="{ name: 'Cliente'}">{{ item.user.name }}</router-link>
                    </div>
    ...
    <CModal size="xl" :visible="employeeModal" @close="closeEmployeeModal()">
      <CModalHeader>
        <CModalTitle v-if="is_edit">Editar Cliente</CModalTitle>
        <CModalTitle v-else>Adicionar Cliente</CModalTitle>
      </CModalHeader>
      <CModalBody>
        <CForm>
          <CRow>
