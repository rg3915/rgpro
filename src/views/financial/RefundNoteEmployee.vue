  ...
  <div>
    <CRow>
      <CCol :md="12">
        <CCard class="mb-4">
          <CCardHeader>
            Detalhes da Nota de Reembolso do Funcionário
            <CButton
              color="primary"
              variant="link"
              size="sm"
            ...
            <CCard style="width: 18rem">
              <CCardHeader>
                ...
                <span class="float-end">
                  <CBadge color="success" v-if="item.is_paid">Pago</CBadge>
                  <CBadge color="danger" v-else>Não Pago</CBadge>
                </span>
              </CCardHeader>
              <CListGroup flush>
                <CListGroupItem>
